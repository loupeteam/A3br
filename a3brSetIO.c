...
void A3brSetIOErrorCallback( struct A3brSetIO* inst, httpResponseHeader_t * header, unsigned char * data){
...
void A3brSetIOSuccessCallback( struct A3brSetIO* inst, httpResponseHeader_t * header, unsigned char * data){
